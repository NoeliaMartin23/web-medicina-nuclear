...
export const introductionSearchEntries: SearchEntry[] = [
  {
    id: 'search-introduccion',
    sectionId: 'introduccion',
    sectionLabel: 'Introducción',
    title: 'Introducción',
    content:
      'La medicina nuclear emplea radiotrazadores o radiofármacos con fines diagnósticos y terapéuticos. Incluye control de calidad, mantenimiento de equipos, protección radiológica, gestión del material y documentación técnica para un funcionamiento seguro y eficiente de la instalación.',
    resultType: 'section',
  },
];
